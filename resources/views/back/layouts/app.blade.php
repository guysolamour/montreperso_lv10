...
<head>
    ...
    {{-- <link rel="stylesheet" --}}
        {{-- href="{{ asset('vendor/themekit/plugins/tempusdominus-bootstrap-4/build/css/tempusdominus-bootstrap-4.min.css') }}"> --}}
...
<body>
    ...
    {{-- <script
        src="{{ asset('vendor/themekit/plugins/tempusdominus-bootstrap-4/build/js/tempusdominus-bootstrap-4.min.js') }}">
    </script> --}}
