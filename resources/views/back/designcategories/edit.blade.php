...
@section('title','Edition ' . $designcategory->name)
                ...
                <div class="col-lg-4">
                       <nav class="breadcrumb-container" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item">
                                <a href="{{ route('back.designcategory.show', $designcategory) }}">{{ $designcategory->name }}
                                </a>
                            </li>
            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-8">
                                @include('back.designcategories._form', ['edit' => true])
                            </div>
                            <div class="col-md-4">
